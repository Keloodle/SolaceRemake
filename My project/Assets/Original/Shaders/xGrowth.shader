...
Shader "James/xGrowth"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_Size("Size", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord1 = IN.ase_texcoord7.xy * float2( 4,4 ) + float2( -2,-2 );
				float temp_output_21_0 = ( ( 1.0 - (-0.59 + (max( max( texCoord1.x , texCoord1.y ) , -min( texCoord1.x , texCoord1.y ) ) - -0.98) * (4.51 - -0.59) / (8.83 - -0.98)) ) * _Size * 3.0 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord1 = IN.ase_texcoord2.xy * float2( 4,4 ) + float2( -2,-2 );
				float temp_output_21_0 = ( ( 1.0 - (-0.59 + (max( max( texCoord1.x , texCoord1.y ) , -min( texCoord1.x , texCoord1.y ) ) - -0.98) * (4.51 - -0.59) / (8.83 - -0.98)) ) * _Size * 3.0 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord1 = IN.ase_texcoord3.xy * float2( 4,4 ) + float2( -2,-2 );
				float temp_output_21_0 = ( ( 1.0 - (-0.59 + (max( max( texCoord1.x , texCoord1.y ) , -min( texCoord1.x , texCoord1.y ) ) - -0.98) * (4.51 - -0.59) / (8.83 - -0.98)) ) * _Size * 3.0 );
...
/*ASEBEGIN
Version=18900
1829;73;912;769;-188.8901;-69.83423;1;True;False
...
WireConnection;39;6;21;0
ASEEND*/
//CHKSM=D642C8BF7D0BCCB2827F49E9BE0C5AD21D07F6E3